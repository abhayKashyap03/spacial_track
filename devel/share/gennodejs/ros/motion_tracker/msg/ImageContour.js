...
class ImageContour {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('ann_file')) {
        this.ann_file = initObj.ann_file
      }
      else {
        this.ann_file = '';
      }
      ...
      if (initObj.hasOwnProperty('prevFrame')) {
        this.prevFrame = initObj.prevFrame
      }
      else {
        this.prevFrame = new sensor_msgs.msg.Image();
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [ann_file]
    bufferOffset = _serializer.string(obj.ann_file, buffer, bufferOffset);
    // Serialize message field [frame]
    bufferOffset = sensor_msgs.msg.Image.serialize(obj.frame, buffer, bufferOffset);
    // Serialize message field [prevFrame]
    bufferOffset = sensor_msgs.msg.Image.serialize(obj.prevFrame, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [ann_file]
    data.ann_file = _deserializer.string(buffer, bufferOffset);
    // Deserialize message field [frame]
    data.frame = sensor_msgs.msg.Image.deserialize(buffer, bufferOffset);
    // Deserialize message field [prevFrame]
    data.prevFrame = sensor_msgs.msg.Image.deserialize(buffer, bufferOffset);
  ...
  static getMessageSize(object) {
    let length = 0;
    length += _getByteLength(object.ann_file);
    length += sensor_msgs.msg.Image.getMessageSize(object.frame);
    length += sensor_msgs.msg.Image.getMessageSize(object.prevFrame);
  ...
  static Resolve(msg) {
    ...
    if (msg.ann_file !== undefined) {
      resolved.ann_file = msg.ann_file;
    }
    else {
      resolved.ann_file = ''
    }
    ...
    if (msg.prevFrame !== undefined) {
      resolved.prevFrame = sensor_msgs.msg.Image.Resolve(msg.prevFrame)
    }
    else {
      resolved.prevFrame = new sensor_msgs.msg.Image()
    }
