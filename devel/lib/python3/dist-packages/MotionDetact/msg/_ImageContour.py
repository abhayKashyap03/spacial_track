...
"""autogenerated by genpy from MotionDetact/ImageContour.msg. Do not edit."""
import codecs
import sys
...
class ImageContour(genpy.Message):
  _md5sum = "99ce6b969f78ad0c2518c2eacf95bee1"
  _type = "MotionDetact/ImageContour"
...
string frame_id
"""
  __slots__ = ['frame','firstFrame','gray_frame']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.firstFrame is None:
        self.firstFrame = sensor_msgs.msg.Image()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_3I().pack(_x.firstFrame.header.seq, _x.firstFrame.header.stamp.secs, _x.firstFrame.header.stamp.nsecs))
      _x = self.firstFrame.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.firstFrame.height, _x.firstFrame.width))
      _x = self.firstFrame.encoding
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_BI().pack(_x.firstFrame.is_bigendian, _x.firstFrame.step))
      _x = self.firstFrame.data
      length = len(_x)
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(struct.Struct('<I%sB'%length).pack(length, *_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.firstFrame.header.seq, _x.firstFrame.header.stamp.secs, _x.firstFrame.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.firstFrame.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.firstFrame.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.firstFrame.height, _x.firstFrame.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.firstFrame.encoding = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.firstFrame.encoding = str[start:end]
      _x = self
      start = end
      end += 5
      (_x.firstFrame.is_bigendian, _x.firstFrame.step,) = _get_struct_BI().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      end += length
      self.firstFrame.data = str[start:end]
      _x = self
      start = end
      end += 12
